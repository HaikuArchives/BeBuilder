#ifndef __MENU_CODE_GENERATOR_H__
#define __MENU_CODE_GENERATOR_H__
#include "CodeGenerator.h"
#include <Entry.h>
#include <MenuField.h>
class TMenuComponent;
class TMenuCodeGenerator : public TCodeGenerator
{
	public :
		TMenuCodeGenerator(TMenuComponent * AMenuComponent,bool CanCreateSourceFile);
